package com.itek.library_common.widget;
...
import com.itek.library_common.R;
...
public class EmptyLayout extends LinearLayout {
    ...
    private int mErrorDrawable = R.drawable.ic_bg_empty;
    private int mEmptyDrawable = R.drawable.ic_bg_empty;
    private int mLoadingDrawable = R.drawable.dialog_loading_img;

    private String mErrorMessage = "网络连接失败";
    private String mEmptyMessage = "暂无信息";
...
//        getChildViews();
     ...
     * @param emptyMessage the message
     */
    public void setEmptyMessageButtonText(String emptyMessage) {
        TextView emptyViewButton = mEmptyView.findViewById(mEmptyViewButtonId);
        emptyViewButton.setText(emptyMessage);
    }
    ...
    private boolean isEmptyView(View view) {
        return (view == null || mEmptyRelativeLayout == view || view == mLoadingView || view == mEmptyView || view == mErrorView);
    }
    ...
    public void setEmptyViewButtonVisibility(boolean visibility) {
        View emptyViewButton = mEmptyView.findViewById(mEmptyViewButtonId);
        emptyViewButton.setVisibility(visibility ? VISIBLE : View.INVISIBLE);
    }
...
//                        loadingAnimationView.setBackgroundResource(R.drawable.loading);
                        AnimationDrawable drawable = (AnimationDrawable) loadingAnimationView.getBackground();
                        drawable.start();
                    }
                }
                break;
